            ...
            <div className="lg:col-span-8 space-y-6">
               ...
               <div className="flex p-1 bg-slate-100 rounded-2xl border border-slate-200 w-fit">
                  <button
                     ...
                     className={`flex items-center gap-2 px-6 py-3 rounded-xl text-sm font-bold transition-all ${meetingMode === 'SCHEDULE'
                  ...
                  <button
                     ...
                     className={`flex items-center gap-2 px-6 py-3 rounded-xl text-sm font-bold transition-all ${meetingMode === 'INSTANT'
                        ? 'bg-white text-slate-900 shadow-sm'
                        : 'text-slate-500 hover:text-slate-700'
                        }`}
                  >
